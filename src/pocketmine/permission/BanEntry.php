...
use DateTime;use RuntimeException;use function array_shift;use function explode;use function implode;use function strlen;use function strtolower;use function trim;
class BanEntry{
