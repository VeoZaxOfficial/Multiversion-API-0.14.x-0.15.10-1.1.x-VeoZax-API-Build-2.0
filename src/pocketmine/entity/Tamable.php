...
use pocketmine\nbt\tag\StringTag;use pocketmine\utils\UUID;use function boolval;use function intval;use function strlen;
abstract class Tamable extends Animal{
    ...
    protected function initEntity() : void{
        ...
        if($this->namedtag->hasTag("OwnerUUID", StringTag::class)){
            ...
            if(strlen($uuid) === 16){
                $owner = $this->server->getPlayerByUUID(UUID::fromString($uuid)); 
                if($owner !== null){
