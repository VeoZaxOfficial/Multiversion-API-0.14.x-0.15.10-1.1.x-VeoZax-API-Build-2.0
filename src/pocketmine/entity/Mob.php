...
use pocketmine\block\Lava;use pocketmine\block\Liquid;use pocketmine\block\Water;use pocketmine\entity\behavior\BehaviorPool;use pocketmine\entity\helper\EntityBodyHelper;use pocketmine\entity\helper\EntityJumpHelper;use pocketmine\entity\helper\EntityLookHelper;use pocketmine\entity\helper\EntityMoveHelper;use pocketmine\entity\pathfinder\EntityNavigator;use pocketmine\math\Vector3;use pocketmine\Player;use pocketmine\timings\Timings;use function abs;use function boolval;use function in_array;use function intval;
