...
use pocketmine\block\Block;use pocketmine\block\Grass;use pocketmine\item\Item;use pocketmine\math\Vector3;use pocketmine\network\mcpe\protocol\ActorEventPacket;use pocketmine\Player;use function max;
abstract class Animal extends Mob implements Ageable{
	protected $inLove = 0;
	protected $spawnableBlock = Block::GRASS;
    protected $reproduceCooldown = null;
    public const REPRODUCE_COOLDOWN = 20 * 60 * 300; 
