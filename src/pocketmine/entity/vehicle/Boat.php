...
use pocketmine\block\Water;use pocketmine\entity\Entity;use pocketmine\entity\Vehicle;use pocketmine\event\entity\EntityDamageByEntityEvent;use pocketmine\event\entity\EntityDamageEvent;use pocketmine\item\Item;use pocketmine\item\ItemFactory;use pocketmine\math\AxisAlignedBB;use pocketmine\math\Vector3;use pocketmine\network\mcpe\protocol\ProtocolInfo;use pocketmine\network\mcpe\protocol\SetActorLinkPacket;use pocketmine\network\mcpe\protocol\types\EntityLink;use pocketmine\Player;
class Boat extends Vehicle{
	...
	protected function broadcastLink(Player $player = null, int $type = EntityLink::TYPE_RIDER) : void{
		foreach($this->getViewers() as $viewer){
			...
			if($player->getProtocol() >= ProtocolInfo::PROTOCOL_90){ 
