...
use InvalidArgumentException;use pocketmine\entity\Entity;use pocketmine\entity\Human;use pocketmine\nbt\tag\IntTag;use pocketmine\nbt\tag\ShortTag;use pocketmine\Player;use function sqrt;
class ExperienceOrb extends Entity{
	...
	protected function initEntity() : void{
		...
		$value = 0;
		if($this->namedtag->hasTag(self::TAG_VALUE_PC, ShortTag::class)){ 
			$value = $this->namedtag->getShort(self::TAG_VALUE_PC);
		}elseif($this->namedtag->hasTag(self::TAG_VALUE_PE, IntTag::class)){ 
