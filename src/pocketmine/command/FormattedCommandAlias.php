...
use InvalidArgumentException;use pocketmine\Server;use pocketmine\utils\TextFormat;use function count;use function ord;use function strlen;use function strpos;use function substr;
