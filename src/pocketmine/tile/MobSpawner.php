...
use pocketmine\block\Air;use pocketmine\entity\Entity;use pocketmine\entity\Mob;use pocketmine\level\Level;use pocketmine\math\Vector3;use pocketmine\nbt\tag\CompoundTag;use pocketmine\Player;use pocketmine\Server;
class MobSpawner extends Spawnable{
	...
	public const TAG_SPAWN_DATA = "SpawnData"; 
