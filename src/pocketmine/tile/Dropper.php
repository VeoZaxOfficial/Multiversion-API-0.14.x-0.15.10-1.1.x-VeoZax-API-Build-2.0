...
use pocketmine\block\Block;use pocketmine\entity\object\ItemEntity;use pocketmine\inventory\DropperInventory;use pocketmine\inventory\InventoryHolder;use pocketmine\item\Item;use pocketmine\level\particle\SmokeParticle;use pocketmine\math\Vector3;use pocketmine\nbt\tag\CompoundTag;use function count;use function is_array;use function mt_rand;
