...
use pocketmine\thread\Thread;use function count;use function exec;use function fclose;use function file;use function file_get_contents;use function function_exists;use function getmypid;use function getmyuid;use function hexdec;use function memory_get_usage;use function posix_kill;use function preg_match;use function proc_close;use function proc_open;use function str_starts_with;use function stream_get_contents;use function trim;
final class Process{
	...
	public static function getThreadCount() : int{
		...
		return Thread::getRunningCount() + 1; 
	}
