...
use Closure;use DaveRandom\CallbackValidator\CallbackType;use DaveRandom\CallbackValidator\InvalidCallbackException;use pocketmine\errorhandler\ErrorTypeToStringMap;use pocketmine\thread\ThreadCrashInfoFrame;use pocketmine\log\MainLogger;use ErrorException;use Exception;use InvalidArgumentException;use pocketmine\thread\ThreadManager;use ReflectionClass;use ReflectionException;use ReflectionFunction;use RuntimeException;use TypeError;use function array_combine;use function array_map;use function array_reverse;use function array_values;use function base64_decode;use function bin2hex;use function chunk_split;use function count;use function debug_zval_dump;use function dechex;use function error_reporting;use function exec;use function explode;use function fclose;use function file;use function file_exists;use function file_get_contents;use function function_exists;use function get_current_user;use function get_loaded_extensions;use function getenv;use function gettype;use function hexdec;use function implode;use function is_array;use function is_object;use function is_readable;use function is_string;use function json_decode;use function memory_get_usage;use function ob_end_clean;use function ob_get_contents;use function ob_start;use function ord;use function php_uname;use function phpversion;use function posix_kill;use function preg_grep;use function preg_match;use function preg_match_all;use function preg_replace;use function proc_close;use function proc_open;use function sha1;use function spl_object_hash;use function str_pad;use function str_replace;use function str_split;use function stream_get_contents;use function stripos;use function strlen;use function strpos;use function strtolower;use function substr;use function sys_get_temp_dir;use function trim;use function xdebug_get_function_stack;use const PHP_EOL;use const PHP_INT_MAX;use const PHP_INT_SIZE;use const PHP_MAXPATHLEN;use const pocketmine\PATH;use const pocketmine\PLUGIN_PATH;use const STR_PAD_LEFT;use const STR_PAD_RIGHT;
class Utils{
	public static $os;
