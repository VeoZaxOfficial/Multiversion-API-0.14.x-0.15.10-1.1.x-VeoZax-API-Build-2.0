...
use pocketmine\item\Item;use pocketmine\level\sound\DoorSound;use pocketmine\math\AxisAlignedBB;use pocketmine\math\Vector3;use pocketmine\Player;
abstract class Door extends Transparent implements ElectricalAppliance{
	...
	public function place(Item $item, Block $blockReplace, Block $blockClicked, int $face, Vector3 $clickVector, Player $player = null) : bool{
		if($face === Vector3::SIDE_UP){
			...
			$this->getLevelNonNull()->setBlock($blockUp, BlockFactory::get($this->getId(), $metaUp), true); 
			return true;
		}
		return false;
	}
