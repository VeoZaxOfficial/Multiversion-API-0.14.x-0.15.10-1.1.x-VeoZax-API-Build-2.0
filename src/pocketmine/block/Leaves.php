...
use pocketmine\event\block\LeavesDecayEvent;use pocketmine\item\Item;use pocketmine\item\ItemFactory;use pocketmine\math\Vector3;use pocketmine\Player;use function mt_rand;
class Leaves extends Transparent{
	...
	public function getDrops(Item $item) : array{
		...
		if($this->canDropApples() and mt_rand(1, 200) === 1){ 
