...
use pocketmine\level\sound\PistonInSound;use pocketmine\level\sound\PistonOutSound;use pocketmine\math\Vector3;use pocketmine\Player;use pocketmine\tile\PistonHead as PistonHeadTile;use pocketmine\tile\Tile;use pocketmine\item\Item;use pocketmine\item\ItemFactory;use function abs;use function in_array;use function count;
