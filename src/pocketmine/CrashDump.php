...
class CrashDump{
	...
	private function generalData(){
		...
		$this->addLine($this->server->getName() . " version: 0.2+VZ [Protocol " . ProtocolInfo::CURRENT_PROTOCOL . "]");
