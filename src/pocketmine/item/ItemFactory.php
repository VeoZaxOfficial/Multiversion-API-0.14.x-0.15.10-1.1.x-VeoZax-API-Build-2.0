...
use InvalidArgumentException;use pocketmine\block\Block;use pocketmine\block\BlockFactory;use pocketmine\nbt\tag\CompoundTag;use RuntimeException;use SplFixedArray;use TypeError;use function constant;use function defined;use function explode;use function get_class;use function gettype;use function is_numeric;use function is_object;use function is_string;use function str_replace;use function strtoupper;use function trim;
class ItemFactory{
	...
	public static function init(){
		...
		self::registerItem(new Item(Item::BLEACH, 0, "Bleach")); 
