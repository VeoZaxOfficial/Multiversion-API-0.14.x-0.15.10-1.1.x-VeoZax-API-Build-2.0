...
use pocketmine\network\mcpe\NetworkSession;use pocketmine\network\mcpe\protocol\types\ContainerIds;use function chr;use function ord;
class ContainerSetContentPacket extends DataPacket{
	...
	public function decodePayload(){
		...
		$hotbarCount = $this->getProtocol() >= ProtocolInfo::PROTOCOL_90 ? $this->getUnsignedVarInt() : $this->getShort(); 
