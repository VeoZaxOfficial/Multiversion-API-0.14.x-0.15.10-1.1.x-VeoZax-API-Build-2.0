...
interface EntityMetadataFlags{
    ...
    public const DATA_FLAG_SHOW_TRIDENT_ROPE = 52; 
    public const DATA_FLAG_CONTAINER_PRIVATE = 53; 
    public const DATA_FLAG_TRANSFORMING = 54;
    public const DATA_FLAG_SPIN_ATTACK = 55;
    public const DATA_FLAG_SWIMMING = 56;
    public const DATA_FLAG_BRIBED = 57; 
    ...
    public const DATA_FLAG_BLOCKING = 71; 
