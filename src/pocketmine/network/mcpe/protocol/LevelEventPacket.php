...
use pocketmine\block\Block;use pocketmine\math\Vector3;use pocketmine\network\mcpe\multiversion\block\BlockPalette;use pocketmine\level\particle\Particle;use pocketmine\network\mcpe\multiversion\MultiversionEnums;use pocketmine\network\mcpe\NetworkSession;
class LevelEventPacket extends DataPacket{
    ...
    public const EVENT_BONE_MEAL_USE = 2005; 
	...
	public const EVENT_PARTICLE_EXPLODE = 2025; 
	...
	public const EVENT_COPPER_WAX_ON = 2030; 
	public const EVENT_COPPER_WAX_OFF = 2031; 
	public const EVENT_COPPER_SCRAPE = 2032; 
	...
	public const EVENT_PAUSE_GAME = 3005; 
	public const EVENT_PAUSE_GAME_NO_SCREEN = 3006; 
	public const EVENT_SET_GAME_SPEED = 3007; 
	...
	protected function encodePayload(){
		...
		$this->putVector3Nullable($this->position);
            ...
            if($this->getProtocol() >= ProtocolInfo::PROTOCOL_90){
                ...
                $data = $this->data;
                if($this->evid >= self::EVENT_ADD_PARTICLE_MASK){
                    $particleId = $this->evid % self::EVENT_ADD_PARTICLE_MASK;
