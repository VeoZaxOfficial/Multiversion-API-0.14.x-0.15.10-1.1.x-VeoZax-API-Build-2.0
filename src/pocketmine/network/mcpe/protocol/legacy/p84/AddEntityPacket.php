...
class AddEntityPacket extends DataPacket{
	...
	public function encode(){
		...
		$this->buffer .= (ENDIANNESS === 0 ? pack("f", $this->yaw * 0.71111) : strrev(pack("f", $this->yaw * 0.71111)));
		$this->buffer .= (ENDIANNESS === 0 ? pack("f", $this->pitch * 0.71111) : strrev(pack("f", $this->pitch * 0.71111)));
		$this->buffer .= pack("N", $this->modifiers);
