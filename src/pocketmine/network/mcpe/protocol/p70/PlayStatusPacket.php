...
declare(strict_types=1);namespace pocketmine\network\mcpe\protocol\p70;use pocketmine\network\mcpe\protocol\PacketsIds\PacketsIds70;class PlayStatusPacket extends LegacyDataPacket {
    public const NETWORK_ID = PacketsIds70::PLAY_STATUS_PACKET;
    ...
    protected function encodePayload() : void {
        ...
        $this->buffer .= $this->wInt($this->status);
    }}