...
use Generator;use InvalidArgumentException;use pocketmine\network\mcpe\NetworkBinaryStream;use pocketmine\network\mcpe\NetworkSession;use pocketmine\utils\Binary;use UnexpectedValueException;use function get_class;use function strlen;use function unpack;use function substr;use function zlib_decode;use function zlib_encode;use const ZLIB_ENCODING_DEFLATE;
class OldBatchPacket extends DataPacket{
	...
	protected function decodePayload(){
		...
		$this->payload = @zlib_decode($payload, 1024 * 1024 * 2); 
	}
