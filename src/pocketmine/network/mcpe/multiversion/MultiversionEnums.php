...
use Closure;use pocketmine\level\particle\Particle;use pocketmine\network\mcpe\multiversion\constants\AttributeNameIds;use pocketmine\network\mcpe\multiversion\constants\CommandArgumentTypeIds;use pocketmine\network\mcpe\multiversion\constants\LevelSoundIds;use pocketmine\network\mcpe\multiversion\constants\ParticleIds;use pocketmine\network\mcpe\multiversion\constants\PlayerActionIds;use pocketmine\network\mcpe\multiversion\constants\ResourcePackTypeIds;use pocketmine\network\mcpe\multiversion\constants\TextPacketTypeIds;use pocketmine\network\mcpe\multiversion\constants\ItemStackRequestActionTypeIds;use pocketmine\network\mcpe\multiversion\utils\TableConverter;use pocketmine\network\mcpe\protocol\AvailableCommandsPacket;use pocketmine\network\mcpe\protocol\LevelSoundEventPacket;use pocketmine\network\mcpe\protocol\PlayerActionPacket;use pocketmine\network\mcpe\protocol\TextPacket;use pocketmine\network\mcpe\protocol\types\ResourcePackType;use pocketmine\network\mcpe\protocol\types\inventory\stackrequest\ItemStackRequestActionType;use ReflectionClass;use RuntimeException;use SplFixedArray;use function array_filter;use function end;use function is_int;use function substr;use const ARRAY_FILTER_USE_BOTH;
