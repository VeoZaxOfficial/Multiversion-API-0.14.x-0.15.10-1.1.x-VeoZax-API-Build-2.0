...
use pocketmine\entity\Entity;use pocketmine\network\mcpe\multiversion\utils\ActorMetadataConvertor;use pocketmine\network\mcpe\protocol\ProtocolInfo;use pocketmine\network\mcpe\protocol\types\entity\EntityMetadataFlags;use pocketmine\network\mcpe\protocol\types\entity\EntityMetadataProperties;use ReflectionClass;
final class MetadataConvertor{
    ...
    public static function updateMeta(array $metadata, int $playerProtocol) : array{
        ...
        if( isset($metadata[EntityMetadataProperties::DATA_TARGET_EID]) && $metadata[EntityMetadataProperties::DATA_TARGET_EID][1] === 0 ){
    ...
    public static function rollbackMeta(array $metadata, int $playerProtocol) : array{
        ...
        if( isset($metadata[EntityMetadataProperties::DATA_TARGET_EID]) && $metadata[EntityMetadataProperties::DATA_TARGET_EID][1] === -1 ){
