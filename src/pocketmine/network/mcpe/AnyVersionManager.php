...
use pocketmine\network\mcpe\protocol\ProtocolInfo;use pocketmine\block\Block;use pocketmine\network\mcpe\multiversion\MultiversionEnums;use pocketmine\network\mcpe\multiversion\MetadataConvertor;
use pocketmine\network\mcpe\protocol\legacy\p70\AddEntityPacket       as LegAddEntity;use pocketmine\network\mcpe\protocol\legacy\p70\AddItemEntityPacket    as LegAddItemEntity;use pocketmine\network\mcpe\protocol\legacy\p70\AddPaintingPacket      as LegAddPainting;use pocketmine\network\mcpe\protocol\legacy\p70\AddPlayerPacket        as LegAddPlayer;use pocketmine\network\mcpe\protocol\legacy\p70\AdventureSettingsPacket as LegAdventure;use pocketmine\network\mcpe\protocol\legacy\p70\AnimatePacket          as LegAnimate;use pocketmine\network\mcpe\protocol\legacy\p70\BatchPacket            as LegBatch;use pocketmine\network\mcpe\protocol\legacy\p70\BlockEntityDataPacket  as LegBlockEntity;use pocketmine\network\mcpe\protocol\legacy\p70\BlockEventPacket       as LegBlockEvent;use pocketmine\network\mcpe\protocol\legacy\p70\ChangeDimensionPacket  as LegChangeDim;use pocketmine\network\mcpe\protocol\legacy\p70\ChunkRadiusUpdatePacket as LegChunkRadius;use pocketmine\network\mcpe\protocol\legacy\p70\ClientboundMapItemDataPacket as LegMapData;use pocketmine\network\mcpe\protocol\legacy\p70\ContainerClosePacket   as LegContClose;use pocketmine\network\mcpe\protocol\legacy\p70\ContainerOpenPacket    as LegContOpen;use pocketmine\network\mcpe\protocol\legacy\p70\ContainerSetContentPacket as LegContContent;use pocketmine\network\mcpe\protocol\legacy\p70\ContainerSetDataPacket  as LegContData;use pocketmine\network\mcpe\protocol\legacy\p70\ContainerSetSlotPacket  as LegContSlot;use pocketmine\network\mcpe\protocol\legacy\p70\CraftingDataPacket     as LegCraftData;use pocketmine\network\mcpe\protocol\legacy\p70\CraftingEventPacket    as LegCraftEvent;use pocketmine\network\mcpe\protocol\legacy\p70\DisconnectPacket       as LegDisconnect;use pocketmine\network\mcpe\protocol\legacy\p70\DropItemPacket         as LegDropItem;use pocketmine\network\mcpe\protocol\legacy\p70\EntityEventPacket      as LegEntityEvent;use pocketmine\network\mcpe\protocol\legacy\p70\ExplodePacket          as LegExplode;use pocketmine\network\mcpe\protocol\legacy\p70\FullChunkDataPacket    as LegChunkData;use pocketmine\network\mcpe\protocol\legacy\p70\HurtArmorPacket        as LegHurtArmor;use pocketmine\network\mcpe\protocol\legacy\p70\InteractPacket         as LegInteract;use pocketmine\network\mcpe\protocol\legacy\p70\LevelEventPacket       as LegLevelEvent;use pocketmine\network\mcpe\protocol\legacy\p70\MobArmorEquipmentPacket as LegMobArmor;use pocketmine\network\mcpe\protocol\legacy\p70\MobEffectPacket        as LegMobEffect;use pocketmine\network\mcpe\protocol\legacy\p70\MobEquipmentPacket     as LegMobEquip;use pocketmine\network\mcpe\protocol\legacy\p70\MoveEntityPacket       as LegMoveEntity;use pocketmine\network\mcpe\protocol\legacy\p70\MovePlayerPacket       as LegMovePlayer;use pocketmine\network\mcpe\protocol\legacy\p70\PlayerActionPacket     as LegPlayerAction;use pocketmine\network\mcpe\protocol\legacy\p70\PlayerInputPacket      as LegPlayerInput;use pocketmine\network\mcpe\protocol\legacy\p70\PlayerListPacket       as LegPlayerList;use pocketmine\network\mcpe\protocol\legacy\p70\PlayStatusPacket       as LegPlayStatus;use pocketmine\network\mcpe\protocol\legacy\p70\RemoveBlockPacket      as LegRemoveBlock;use pocketmine\network\mcpe\protocol\legacy\p70\RemoveEntityPacket     as LegRemoveEntity;use pocketmine\network\mcpe\protocol\legacy\p70\RemovePlayerPacket     as LegRemovePlayer;use pocketmine\network\mcpe\protocol\legacy\p70\RespawnPacket          as LegRespawn;use pocketmine\network\mcpe\protocol\legacy\p70\SetDifficultyPacket    as LegSetDifficulty;use pocketmine\network\mcpe\protocol\legacy\p70\SetEntityDataPacket    as LegSetEntityData;use pocketmine\network\mcpe\protocol\legacy\p70\SetEntityLinkPacket    as LegSetEntityLink;use pocketmine\network\mcpe\protocol\legacy\p70\SetEntityMotionPacket  as LegSetEntityMotion;use pocketmine\network\mcpe\protocol\legacy\p70\SetHealthPacket        as LegSetHealth;use pocketmine\network\mcpe\protocol\legacy\p70\SetPlayerGameTypePacket as LegSetGametype;use pocketmine\network\mcpe\protocol\legacy\p70\SetSpawnPositionPacket as LegSetSpawn;use pocketmine\network\mcpe\protocol\legacy\p70\SetTimePacket          as LegSetTime;use pocketmine\network\mcpe\protocol\legacy\p70\StartGamePacket        as LegStartGame;use pocketmine\network\mcpe\protocol\legacy\p70\TakeItemEntityPacket   as LegTakeItem;use pocketmine\network\mcpe\protocol\legacy\p70\TextPacket             as LegText;use pocketmine\network\mcpe\protocol\legacy\p70\UpdateAttributesPacket as LegUpdateAttr;use pocketmine\network\mcpe\protocol\legacy\p70\UpdateBlockPacket      as LegUpdateBlock;
use pocketmine\network\mcpe\protocol\PlayStatusPacket;use pocketmine\network\mcpe\protocol\DisconnectPacket;use pocketmine\network\mcpe\protocol\BatchPacket;use pocketmine\network\mcpe\protocol\TextPacket;use pocketmine\network\mcpe\protocol\SetTimePacket;use pocketmine\network\mcpe\protocol\StartGamePacket;use pocketmine\network\mcpe\protocol\AddPlayerPacket;use pocketmine\network\mcpe\protocol\AddActorPacket;use pocketmine\network\mcpe\protocol\RemoveActorPacket;use pocketmine\network\mcpe\protocol\AddItemActorPacket;use pocketmine\network\mcpe\protocol\TakeItemActorPacket;use pocketmine\network\mcpe\protocol\MoveActorAbsolutePacket;use pocketmine\network\mcpe\protocol\MovePlayerPacket;use pocketmine\network\mcpe\protocol\RemoveBlockPacket;use pocketmine\network\mcpe\protocol\UpdateBlockPacket;use pocketmine\network\mcpe\protocol\AddPaintingPacket;use pocketmine\network\mcpe\protocol\ExplodePacket;use pocketmine\network\mcpe\protocol\LevelEventPacket;use pocketmine\network\mcpe\protocol\LevelSoundEventPacket;use pocketmine\network\mcpe\protocol\BlockEventPacket;use pocketmine\network\mcpe\protocol\ActorEventPacket;use pocketmine\network\mcpe\protocol\MobEffectPacket;use pocketmine\network\mcpe\protocol\UpdateAttributesPacket;use pocketmine\network\mcpe\protocol\MobEquipmentPacket;use pocketmine\network\mcpe\protocol\MobArmorEquipmentPacket;use pocketmine\network\mcpe\protocol\ContainerSetSlotPacket;use pocketmine\network\mcpe\protocol\InteractPacket;use pocketmine\network\mcpe\protocol\HurtArmorPacket;use pocketmine\network\mcpe\protocol\SetActorDataPacket;use pocketmine\network\mcpe\protocol\SetActorMotionPacket;use pocketmine\network\mcpe\protocol\SetActorLinkPacket;use pocketmine\network\mcpe\protocol\SetHealthPacket;use pocketmine\network\mcpe\protocol\SetSpawnPositionPacket;use pocketmine\network\mcpe\protocol\AnimatePacket;use pocketmine\network\mcpe\protocol\RespawnPacket;use pocketmine\network\mcpe\protocol\ContainerOpenPacket;use pocketmine\network\mcpe\protocol\ContainerSetDataPacket;use pocketmine\network\mcpe\protocol\ClientboundMapItemDataPacket;use pocketmine\network\mcpe\protocol\ContainerClosePacket;use pocketmine\network\mcpe\protocol\InventorySlotPacket;use pocketmine\network\mcpe\protocol\InventoryContentPacket;use pocketmine\network\mcpe\protocol\CraftingDataPacket;use pocketmine\network\mcpe\protocol\CraftingEventPacket;use pocketmine\network\mcpe\protocol\DropItemPacket;use pocketmine\network\mcpe\protocol\AdventureSettingsPacket;use pocketmine\network\mcpe\protocol\BlockActorDataPacket;use pocketmine\network\mcpe\protocol\PlayerInputPacket;use pocketmine\network\mcpe\protocol\LevelChunkPacket;use pocketmine\network\mcpe\protocol\SetDifficultyPacket;use pocketmine\network\mcpe\protocol\ChangeDimensionPacket;use pocketmine\network\mcpe\protocol\SetPlayerGameTypePacket;use pocketmine\network\mcpe\protocol\PlayerListPacket;use pocketmine\network\mcpe\protocol\ChunkRadiusUpdatedPacket;use pocketmine\Player;use pocketmine\Server;
class AnyVersionManager {
    private static array $knownPlayerUuids = [];
    public static array $protocolVersions = [
        "0.15" => [80, 81, 82, 83, 84],
    ...
    public static function parsePacket(Player $player, $packet): ?\pocketmine\network\mcpe\protocol\legacy\p70\DataPacket {
        ...
        if($packet instanceof AddPlayerPacket) {
            ...
            $eidForCache = $packet->entityUniqueId ?? $packet->entityRuntimeId ?? 0;
            if($eidForCache !== 0 && $packet->uuid !== null) {
                self::$knownPlayerUuids[$eidForCache] = $packet->uuid;
            }
            return $pk;
        }
        ...
        if($packet instanceof RemoveActorPacket) {
            $realEid = $packet->entityUniqueId ?? 0;
            if (isset(self::$knownPlayerUuids[$realEid])) {
                $pk = new LegRemovePlayer();
                $pk->eid = $realEid;
                $pk->clientId = self::$knownPlayerUuids[$realEid];
                return $pk;
            }
        ...
        if($packet instanceof UpdateBlockPacket) {
            ...
            $pk->records = [[
                ...
                $packet->y    ?? 0,
                $packet->blockId   ?? 0,
                $packet->blockMeta ?? $packet->blockData ?? 0,
                $packet->flags     ?? 0,
            ]];
            return $pk;
        }
        ...
        if($packet instanceof ClientboundMapItemDataPacket) {
            $pk = new LegMapData();
            $pk->mapId    = $packet->mapId ?? 0;
            $pk->type     = $packet->type ?? 0;
            $pk->scale    = $packet->scale ?? 0;
            $pk->width    = $packet->width ?? 128;
            $pk->height   = $packet->height ?? 128;
            $pk->xOffset  = $packet->xOffset ?? 0;
            $pk->yOffset  = $packet->yOffset ?? 0;
            if (empty($packet->colors)) {
                return null;
            }
            $pk->colors       = $packet->colors;
            $pk->isColorArray = true;
            $pk->decorations  = [];
            return $pk;
        }
            ...
            foreach ($packet->entries ?? [] as $entry) {
                if($pk->type === 0) { 
                    ...
                    if(isset($entry->skin) && $entry->skin instanceof \pocketmine\entity\Skin) {
                        ...
                        if($skinLen > 64 * 32 * 4){
                            $skinData = \substr($skinData, 0, 64 * 32 * 4);
                        }elseif($skinLen < 64 * 32 * 4){
                            $skinData = \str_pad($skinData, 64 * 32 * 4, "\x00");
                        }
                    }
                    $pk->entries[] = [
    ...
    public static function parseLegacyPacket(Player $player, \pocketmine\network\mcpe\protocol\legacy\p70\DataPacket $packet): ?\pocketmine\network\mcpe\protocol\DataPacket {
        if($packet instanceof \pocketmine\network\mcpe\protocol\legacy\p70\RequestChunkRadiusPacket) {
        ...
        if($packet instanceof \pocketmine\network\mcpe\protocol\legacy\p70\MovePlayerPacket) {
        ...
        if($packet instanceof \pocketmine\network\mcpe\protocol\legacy\p70\PlayerActionPacket) {
        ...
        if($packet instanceof \pocketmine\network\mcpe\protocol\legacy\p70\TextPacket) {
            static $legacyToModernType = [
                \pocketmine\network\mcpe\protocol\legacy\p70\TextPacket::TYPE_RAW         => TextPacket::TYPE_RAW,
                \pocketmine\network\mcpe\protocol\legacy\p70\TextPacket::TYPE_CHAT        => TextPacket::TYPE_CHAT,
                \pocketmine\network\mcpe\protocol\legacy\p70\TextPacket::TYPE_TRANSLATION => TextPacket::TYPE_TRANSLATION,
                \pocketmine\network\mcpe\protocol\legacy\p70\TextPacket::TYPE_POPUP       => TextPacket::TYPE_POPUP,
                \pocketmine\network\mcpe\protocol\legacy\p70\TextPacket::TYPE_TIP         => TextPacket::TYPE_TIP,
                \pocketmine\network\mcpe\protocol\legacy\p70\TextPacket::TYPE_SYSTEM      => TextPacket::TYPE_SYSTEM,
            ];
            $pk = new TextPacket();
            $pk->setProtocol($player->getProtocol());
        ...
        if($packet instanceof \pocketmine\network\mcpe\protocol\legacy\p70\UseItemPacket) {
        ...
        if($packet instanceof \pocketmine\network\mcpe\protocol\legacy\p70\RemoveBlockPacket) {
    ...
    public static function isProtocol(Player $player, string $version): bool {
        return isset(self::$protocolVersions[$version])
            && in_array($player->getOriginalProtocol(), self::$protocolVersions[$version]);
    }
    ...
    public static function getGameVersion(int $protocol): ?string {
        foreach (self::$protocolVersions as $version => $protocolVersion) {
            if (in_array($protocol, $protocolVersion)) return $version;
        }
        return null;
    }}