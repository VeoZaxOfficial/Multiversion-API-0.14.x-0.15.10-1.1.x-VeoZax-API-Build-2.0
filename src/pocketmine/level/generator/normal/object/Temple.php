...
use pocketmine\block\Block;use pocketmine\level\ChunkManager;use pocketmine\level\generator\object\PopulatorObject;use pocketmine\math\Vector3;use pocketmine\utils\BuildingUtils;use pocketmine\utils\Random;
class Temple extends PopulatorObject{
    ...
    public function placeObject(ChunkManager $level, $x, $y, $z, Random $random){
        ...
        foreach ($this->directions as $direction) {
            ...
            $this->placeBlock($x + $direction[0], $y, $z + $direction[1], Block::STAINED_HARDENED_CLAY, 1);
        }
