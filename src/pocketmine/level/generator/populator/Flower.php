...
use pocketmine\block\Block;use pocketmine\level\ChunkManager;use pocketmine\utils\Random;use pocketmine\block\Flower as FlowerBlock;
class Flower extends Populator{
	...
	public function populate(ChunkManager $level, $chunkX, $chunkZ, Random $random){
		...
		if(count($this->flowerTypes) === 0){
			...
			$this->addType([Block::POPPY, FlowerBlock::TYPE_POPPY]);
			$this->addType([Block::RED_FLOWER, FlowerBlock::TYPE_RED_TULIP]);
			$this->addType([Block::RED_FLOWER, FlowerBlock::TYPE_ORANGE_TULIP]);
			$this->addType([Block::RED_FLOWER, FlowerBlock::TYPE_WHITE_TULIP]);
			$this->addType([Block::RED_FLOWER, FlowerBlock::TYPE_PINK_TULIP]);
			$this->addType([Block::RED_FLOWER, FlowerBlock::TYPE_ALLIUM]);
		}
