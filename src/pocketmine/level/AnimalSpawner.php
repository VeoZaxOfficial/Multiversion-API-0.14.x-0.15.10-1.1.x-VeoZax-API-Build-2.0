...
use Exception;use pocketmine\block\Block;use pocketmine\block\Leaves;use pocketmine\block\Liquid;use pocketmine\block\Water;use pocketmine\entity\Animal;use pocketmine\entity\Creature;use pocketmine\entity\CreatureType;use pocketmine\entity\Entity;use pocketmine\entity\Living;use pocketmine\entity\Mob;use pocketmine\entity\Monster;use pocketmine\entity\SpawnPlacementTypes;use pocketmine\entity\WaterAnimal;use pocketmine\level\biome\Biome;use pocketmine\level\biome\SpawnListEntry;use pocketmine\math\Vector3;use pocketmine\Player;use pocketmine\utils\Random;use pocketmine\utils\WeightedRandomItem;use function array_filter;use function count;use function is_a;
class AnimalSpawner{
