...
use InvalidArgumentException;use pocketmine\nbt\tag\ByteTag;use pocketmine\nbt\tag\CompoundTag;use pocketmine\nbt\tag\FloatTag;use pocketmine\nbt\tag\IntArrayTag;use pocketmine\nbt\tag\IntTag;use pocketmine\nbt\tag\ListTag;use pocketmine\nbt\tag\NamedTag;use pocketmine\nbt\tag\StringTag;use UnexpectedValueException;use function call_user_func;use function chr;use function is_array;use function is_bool;use function is_float;use function is_int;use function is_numeric;use function is_string;use function ord;use function strlen;use function substr;use function zlib_decode;use function zlib_encode;use pocketmine\utils\BinaryDataException;
